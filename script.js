const data = [{ "id": 1, "first_name": "Chadwick", "last_name": "Ayre", "email": "cayre0@cam.ac.uk", "gender": "Male", "img_src": "https://robohash.org/corporisquiaperiam.png?size=50x50&set=set1", "class": 11, "marks": 18, "passing": false, "city": "Moorreesburg" },
        ...
        row.innerHTML = `
            ...
            <td>
                <div class="student-info">
                    <img src="${student.img_src}" alt="Image" class="student-img">
...
document.addEventListener('DOMContentLoaded', () => {
    Table(data);
    let increasing =document.querySelector('#sortAZ');
    let decreasing =document.querySelector('#sortZA');
    let mark =document.querySelector('#sortMarks');
    let pass =document.querySelector('#sortPassing');
    let clas = document.querySelector('#sortClass');
    let gender=document.querySelector('#sortGender');
    ...
    decreasing.addEventListener('click', () => {
        const sortedData = [...data].sort((a, b) => b.last_name.localeCompare(a.last_name));
        Table(sortedData);
    });
    ...
    pass.addEventListener('click', () => {
        const sortedData = [...data].sort((a, b) => b.passing - a.passing);
        Table(sortedData);
    });
